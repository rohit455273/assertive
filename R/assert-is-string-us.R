...
{                                                     
  ...
  assert_engine(is_us_telephone_number, x, msg = msg)        
}
...
{                                                     
  ...
  assert_engine(is_us_telephone_number, x, msg = msg, what = "any")        
}
...
{                                                     
  ...
  assert_engine(is_us_zip_code, x, msg = msg)        
}
...
{                                                     
  ...
  assert_engine(is_us_zip_code, x, msg = msg, what = "any")        
}
